...
dependencies {
    ...
    modImplementation("com.github.sib-energy-craft", "energy-api", project.property("sec_energy_api_version")?.toString())
    modImplementation("com.github.sib-energy-craft", "sec-utils", project.property("sec_utils_version")?.toString())
    modImplementation("com.github.sib-energy-craft", "sec-network", project.property("sec_network_version")?.toString())

    modImplementation("com.github.sib-energy-craft", "energy-containers-api", project.property("sec_energy_containers_api_version")?.toString())
    modImplementation("com.github.sib-energy-craft", "energy-machines-api", project.property("sec_energy_machines_api_version")?.toString())
    modImplementation("com.github.sib-energy-craft", "mod-pipes-api", project.property("sec_mod_pipes_api_version")?.toString())

    modImplementation("com.github.sib-energy-craft", "mod-machines", project.property("sec_mod_machines_version")?.toString())
}
